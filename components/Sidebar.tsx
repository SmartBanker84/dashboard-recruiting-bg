...
export const navItems = [
  ...
  { name: 'Users', href: '/dashboard/recruiting/users', icon: <UserPlus className="h-5 w-5" />, roles: ['recruiter'] },
  { name: 'Audit', href: '/dashboard/recruiting/audit', icon: <FileSearch className="h-5 w-5" />, roles: ['recruiter'] },
  { name: 'Backup', href: '/dashboard/recruiting/backup', icon: <Database className="h-5 w-5" />, roles: ['recruiter'] },
  { name: 'Conversion', href: '/dashboard/recruiting/conversion', icon: <FileBarChart2 className="h-5 w-5" />, roles: ['recruiter'] },
  { name: 'Integrations', href: '/dashboard/recruiting/integrations', icon: <Link2 className="h-5 w-5" />, roles: ['recruiter'] },
  { name: 'KPI', href: '/dashboard/recruiting/kpi', icon: <BarChart2 className="h-5 w-5" />, roles: ['recruiter'] },
  { name: 'Monitoring', href: '/dashboard/recruiting/monitoring', icon: <Activity className="h-5 w-5" />, roles: ['recruiter'] },
  { name: 'Permissions', href: '/dashboard/recruiting/permissions', icon: <Cog className="h-5 w-5" />, roles: ['recruiter'] },
  { name: 'Security', href: '/dashboard/recruiting/security', icon: <ShieldCheck className="h-5 w-5" />, roles: ['recruiter'] },
